...
For a new Mac, run the setup script to install Zsh, Homebrew, Python, Node.js, Ruby, Rust, LLVM, GitHub CLI, GitLab CLI, Docker CLI, QEMU, opencode, and configure Git hooks globally. It also offers to log in to Docker Hub as 'harpertoken':
